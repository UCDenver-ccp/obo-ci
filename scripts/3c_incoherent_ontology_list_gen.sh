...
${CODE_BASE_DIRECTORY}/scripts/classify/create-incoherent-ontology-list.sh -l ${MODIFIED_ONTOLOGY_LIST_FILE} -d ${DOWNLOAD_DIRECTORY} -b ${BASE_DIRECTORY} -o ${INCOHERENT_ONTOLOGY_LIST_FILE_PREFIX} -s ${STATUS_DIRECTORY_INDIVIDUAL}
