...
for index in ${!IDs[*]}; do
  id=${IDs[$index]}
  SCRIPT_FILE="${SCRIPT_DIRECTORY_CLASSIFY}/${id}.elk.expl.compile.sh"
  ELK_OUTPUT_FILE="${EXPLANATION_DIRECTORY_INDIVIDUAL}/${id}_elk.explanation"
  LOG_FILE="${LOG_DIRECTORY_CLASSIFY_EXPLANATION}/${id}_elk.log"
...
for index in ${!IDs[*]}; do
  id=${IDs[$index]}
  SCRIPT_FILE="${SCRIPT_DIRECTORY_CLASSIFY}/${id}.hermit.expl.compile.sh"
  HERMIT_OUTPUT_FILE="${EXPLANATION_DIRECTORY_INDIVIDUAL}/${id}_hermit.explanation"
  LOG_FILE="${LOG_DIRECTORY_CLASSIFY_EXPLANATION}/${id}_hermit.log"
