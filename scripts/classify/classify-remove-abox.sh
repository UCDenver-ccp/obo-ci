...
${MAVEN} -e -f scripts/classify/pom-classify-ontology-remove-abox.xml exec:exec \
...
${MAVEN} -e -f scripts/classify/pom-classify-ontology-pair-remove-abox.xml exec:exec \
        -DontologyFile=${ONT_FILE} \
