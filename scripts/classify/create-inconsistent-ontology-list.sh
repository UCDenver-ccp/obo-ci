...
if [[ -z ${DOWNLOAD_DIRECTORY} || -z ${ONTOLOGY_LIST_FILE} || -z ${INCONSISTENT_ONTOLOGY_LIST_FILE_PREFIX} || -z ${BASE_DIRECTORY} || -z ${STATUS_DIR} ]]; then
	...
	echo "modified ontology list file: ${INCONSISTENT_ONTOLOGY_LIST_FILE_PREFIX}"
...
INCONSISTENT_ONTOLOGY_LIST_FILE_ELK=$(echo "${INCONSISTENT_ONTOLOGY_LIST_FILE_PREFIX}_elk")
INCONSISTENT_ONTOLOGY_LIST_FILE_HERMIT=$(echo "${INCONSISTENT_ONTOLOGY_LIST_FILE_PREFIX}_hermit")
