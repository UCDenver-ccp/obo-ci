...
${CODE_BASE_DIRECTORY}/scripts/download/create-modified-ontology-list.sh -l ${ONTOLOGY_LIST_FILE} -d ${DOWNLOAD_DIRECTORY} -b ${BASE_DIRECTORY} -o ${MODIFIED_ONTOLOGY_LIST_FILE}
