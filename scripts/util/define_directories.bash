...
LOG_DIRECTORY_CLASSIFY_EXPLANATIONS="${WORK_DIRECTORY}/log/classify-explanations"
LOG_DIRECTORY_CLASSIFY_PAIRS="${WORK_DIRECTORY}/log/classify-pairs"
LOG_DIRECTORY_CLASSIFY_PAIRS_EXPLANATIONS="${WORK_DIRECTORY}/log/classify-pairs-explanations"
