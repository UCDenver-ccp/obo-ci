...
ONTOLOGIES_DIRECTORY="${WORK_DIRECTORY}/base/ontologies"
...
STATUS_ARCHIVES_DIRECTORY="${WORK_DIRECTORY}/status-archives"
...
LOG_DIRECTORY_RELATION_EXTRACTION="${WORK_DIRECTORY}/log/relation-extraction"
...
SCRIPT_DIRECTORY_RELATION_ANALYSIS="${WORK_DIRECTORY}/scripts/relation-analysis"

RELATION_DIRECTORY="${WORK_DIRECTORY}/relations"
RELATION_DIRECTORY_BY_ONTOLOGY="${WORK_DIRECTORY}/relations/by_ontology"
